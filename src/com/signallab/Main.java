...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            // Reconstruct and auto-correct data at receiver
            int[] recoveredBits = receiver.processIncomingStream(corruptedBits);

            // 4. Analytics and Metrics Generation
            ...
            report.append("Final Uncorrected Bit Error Rate (BER): ").append(systemBER).append("\n");
            ...
            // Print summary and write report file to disk
            System.out.print("\n" + report.toString());
            ...
            scanner.close();
            System.out.println("\nThank you for using SignalLab Simulator.");
        }
    }
}
